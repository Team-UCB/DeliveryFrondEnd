...
import { DireccionTransportadorComponent } from './registro-transportador/direccion-transportador/direccion-transportador.component';
...
@NgModule({
  declarations: [
    ...
    DireccionTransportadorComponent,
